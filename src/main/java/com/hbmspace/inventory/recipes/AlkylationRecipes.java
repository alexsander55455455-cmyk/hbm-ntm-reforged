...
public class AlkylationRecipes extends SerializableRecipe {
    ...
    public void registerDefaults() {
        ...
        recipes.put(Fluids.UNSATURATEDS, new Tuple.Triplet<>( // iron oxide catalyst in the unit + heat produces cyclic chains
                new FluidStack(Fluids.NONE, 0),
                new FluidStack(Fluids.AROMATICS, 70),
                new FluidStack(Fluids.PETROLEUM, 30)
        ));
        recipes.put(Fluids.AROMATICS, new Tuple.Triplet<>( // Dichloromethane triggers a further alkylation process, creating high-octane aromatics!
        ...
        recipes.put(Fluids.PETROLEUM, new Tuple.Triplet<>( // Alkys are generally used to turn isobutane into gasoline
    ...
    public void readRecipe(JsonElement recipe) {
        ...
        recipes.put(input, new Tuple.Triplet<>(acid, output1, output2));
    }
