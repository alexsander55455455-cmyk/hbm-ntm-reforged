...
public class GUIMachineCryoDistill extends GuiInfoContainer {
    ...
    private static final ResourceLocation texture = new ResourceLocation("hbm:textures/gui/processing/gui_cryodistill.png");
    ...
    protected void drawGuiContainerForegroundLayer(int i, int j) {
        String name = this.cryo.hasCustomName() ? this.cryo.getName() : I18n.format(this.cryo.getDefaultName());

        this.fontRenderer.drawString(name, this.xSize / 2 - this.fontRenderer.getStringWidth(name) / 2, 5, 0xffffff);
        this.fontRenderer.drawString(I18n.format("container.inventory"), 8, this.ySize - 100, 4210752);
    }
