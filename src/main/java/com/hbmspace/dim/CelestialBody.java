...
public class CelestialBody {
	...
	private static final ResourceLocation DEFAULT_SURFACE_TEXTURE = new ResourceLocation("minecraft", "textures/blocks/stone.png");
	public ResourceLocation surfaceTexture = DEFAULT_SURFACE_TEXTURE;
	...
	public CelestialBody withBlockTextures(String stone, String surface) {
		...
		this.surfaceTexture = resolveBlockTextureForBinding(surface);
		return this;
	}

	private static ResourceLocation resolveBlockTextureForBinding(String texture) {
		if(texture == null || texture.isEmpty()) return DEFAULT_SURFACE_TEXTURE;
	...
	public static CelestialBody getBody(World world) {
		return getBody(world.provider.getDimension());
	}
	...
	public static boolean inOrbit(World world) {
		return world.provider.getDimension() == SpaceConfig.orbitDimension;
	}
