...
public class BiomeGenHalogenHills extends BiomeGenBaseTekto {

    public BiomeGenHalogenHills(Biome.BiomeProperties properties) {
        super(properties);

        this.topBlock = ModBlocksSpace.rubber_silt.getDefaultState();
