...
public class BiomeGenPolyvinylPlains extends BiomeGenBaseTekto {

    public BiomeGenPolyvinylPlains(Biome.BiomeProperties properties) {
        super(properties);
    ...
    public void genTerrainBlocks(@NotNull World worldIn, @NotNull Random rand, @NotNull ChunkPrimer chunkPrimerIn, int x, int z, double noise) {
        // Plains uses Basalt as base and Smooth Basalt as alternate
