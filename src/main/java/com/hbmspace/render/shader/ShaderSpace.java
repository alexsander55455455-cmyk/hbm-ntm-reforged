...
public class ShaderSpace {
    ...
    public ShaderSpace(ResourceLocation fragment) {
        this(new ResourceLocation("hbm", "shaders/default.vert"), fragment);
    }

    public ShaderSpace(ResourceLocation vertex, ResourceLocation fragment) {
        try {
            ...
            SpaceMain.logger.error("Shaders failed to load, falling back to default pipeline");
