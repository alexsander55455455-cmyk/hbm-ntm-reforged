...
public class ItemModRecordSpace extends ItemModRecord implements IDynamicModelsSpace {
    String texturePath;
    public ItemModRecordSpace(String p_i46742_1_, SoundEvent soundIn, String name) {
        super(p_i46742_1_, soundIn, name);
        texturePath = name;
