...
public class ModItemSeedFood extends ItemSeedFood implements IDynamicModelsSpace {
    String texturePath;

    public ModItemSeedFood(int healAmount, float saturation, Block crops, Block soil, String s) {
    ...
    public ModItemSeedFood(int healAmount, float saturation, Block crops, Block soil, String s, String tex) {
        super(healAmount, saturation, crops, soil);
        this.setTranslationKey(s);
        this.setRegistryName(s);
        this.setCreativeTab(MainRegistry.consumableTab);
