...
public class ModItems {
    ...
    public static final Item battery_sc = new ItemBatterySC("battery_sc").setMaxStackSize(1);
    ...
    public static final Item battery_sc_balefire = new ItemSelfcharger(25000L, "battery_sc_balefire").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
    public static final Item battery_sc_schrabidium = new ItemSelfcharger(50000L, "battery_sc_schrabidium").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
    public static final Item battery_sc_yharonite = new ItemSelfcharger(500000L, "battery_sc_yharonite").setMaxStackSize(1).setCreativeTab(MainRegistry.controlTab);
    ...
    public static final Item paa_helmet = new ArmorPAA(MaterialRegistry.aMatPaa, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/paa_1.png", "paa_helmet")
            ...
            .setMaxStackSize(1);
    public static final Item paa_plate = new ArmorPAA(MaterialRegistry.aMatPaa, -1, EntityEquipmentSlot.CHEST, Tags.MODID + ":textures/armor/paa_1.png", "paa_plate").cloneStats((ArmorFSB) paa_helmet).setMaxStackSize(1);
    public static final Item paa_legs = new ArmorPAA(MaterialRegistry.aMatPaa, -1, EntityEquipmentSlot.LEGS, Tags.MODID + ":textures/armor/paa_2.png", "paa_legs").cloneStats((ArmorFSB) paa_helmet).setMaxStackSize(1);
    public static final Item paa_boots = new ArmorPAA(MaterialRegistry.aMatPaa, -1, EntityEquipmentSlot.FEET, Tags.MODID + ":textures/armor/paa_1.png", "paa_boots").cloneStats((ArmorFSB) paa_helmet).setMaxStackSize(1);
    public static final Item australium_iii = new ArmorAustralium(MaterialRegistry.aMatAus3, -1, EntityEquipmentSlot.CHEST, "australium_iii").setMaxStackSize(1);
    ...
    public static final Item steel_helmet = new ArmorFSB(MaterialRegistry.aMatSteel, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/steel_1.png", "steel_helmet").setMod(0.9F).setProtectionLevel(20F).setMaxStackSize(1);
    ...
    public static final Item titanium_helmet = new ArmorFSB(MaterialRegistry.aMatTitan, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/titanium_1.png", "titanium_helmet").setMod(0.85F).setProtectionLevel(30F).setMaxStackSize(1);
    ...
    public static final Item alloy_helmet = new ArmorFSB(MaterialRegistry.aMatAlloy, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/alloy_1.png", "alloy_helmet").setMod(0.8F).setProtectionLevel(50F).setMaxStackSize(1);
    ...
    public static final Item cobalt_helmet = new ArmorFSB(MaterialRegistry.aMatCobalt, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/cobalt_1.png", "cobalt_helmet").setProtectionLevel(75F).setMod(0.75F);
    ...
    public static final Item security_helmet = new ArmorFSB(MaterialRegistry.aMatSecurity, 7, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/security_1.png", "security_helmet").setMod(0.65F).setProjectileProtection(0.5F).setProtectionLevel(100F).setMaxStackSize(1);
    ...
    public static final Item starmetal_helmet = new ArmorFSB(MaterialRegistry.aMatStarmetal, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/starmetal_1.png", "starmetal_helmet").setMod(0.5F).setCap(15F)
    ...
    public static final Item schrabidium_legs = new ArmorFSB(MaterialRegistry.aMatSchrab, -1, EntityEquipmentSlot.LEGS, Tags.MODID + ":textures/armor/schrabidium_2.png", "schrabidium_legs").cloneStats((ArmorFSB) schrabidium_helmet).setCap(4F).setMod(0.1F).setMaxStackSize(1);
    public static final Item schrabidium_boots = new ArmorFSB(MaterialRegistry.aMatSchrab, -1, EntityEquipmentSlot.FEET, Tags.MODID + ":textures/armor/schrabidium_1.png", "schrabidium_boots").cloneStats((ArmorFSB) schrabidium_helmet).setCap(4F).setMod(0.1F).setMaxStackSize(1);
    ...
    public static final Item hev_helmet = new ArmorHEV(MaterialRegistry.aMatHEV, 7, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/starmetal_1.png", 5000000, 10000, 2500, 100, "hev_helmet")
            .setCap(4.0F)
            .setThreshold(2.0F)
            .addEffect(new PotionEffect(MobEffects.JUMP_BOOST, 30, 0))
            .addEffect(new PotionEffect(MobEffects.SPEED, 30, 1))
            ...
            .setFireproof(true)
            .setHides(IArmorDisableModel.EnumPlayerPart.HAT)
            .setHazardClass(ArmorUtil.FULL_PACKAGE).setRadResist(1.6D /*97.5%*/)
            .setHasGeigerSound(true)
            .setHasCustomGeiger(true)
            .addResistance("fall", 0.5F);
    public static final Item hev_plate = new ArmorHEV(MaterialRegistry.aMatHEV, 7, EntityEquipmentSlot.CHEST, Tags.MODID + ":textures/armor/starmetal_1.png", 5000000, 10000, 2500, 100, "hev_plate").cloneStats((ArmorFSB) hev_helmet);
    public static final Item hev_legs = new ArmorHEV(MaterialRegistry.aMatHEV, 7, EntityEquipmentSlot.LEGS, Tags.MODID + ":textures/armor/starmetal_2.png", 5000000, 10000, 2500, 100, "hev_legs").cloneStats((ArmorFSB) hev_helmet);
    public static final Item hev_boots = new ArmorHEV(MaterialRegistry.aMatHEV, 7, EntityEquipmentSlot.FEET, Tags.MODID + ":textures/armor/starmetal_1.png", 5000000, 10000, 2500, 100, "hev_boots").cloneStats((ArmorFSB) hev_helmet);
    ...
    public static final Item rpa_helmet = new ArmorRPA(MaterialRegistry.aMatRPA, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/starmetal_1.png", 50000000, 100000, 20000, 500, "RPA_helmet")
            .setCap(6.0F)
            .setFireproof(true)
            .enableVATS(true)
            .setHasGeigerSound(true)
            ...
            .addResistance("monoxide", 0F)
            .addResistance("fall", 0);
    public static final Item rpa_plate = new ArmorRPA(MaterialRegistry.aMatRPA, -1, EntityEquipmentSlot.CHEST, Tags.MODID + ":textures/armor/starmetal_1.png", 50000000, 100000, 20000, 500, "RPA_plate").cloneStats((ArmorFSB) rpa_helmet);
    public static final Item rpa_legs = new ArmorRPA(MaterialRegistry.aMatRPA, -1, EntityEquipmentSlot.LEGS, Tags.MODID + ":textures/armor/starmetal_2.png", 50000000, 100000, 20000, 500, "RPA_legs").cloneStats((ArmorFSB) rpa_helmet);
    public static final Item rpa_boots = new ArmorRPA(MaterialRegistry.aMatRPA, -1, EntityEquipmentSlot.FEET, Tags.MODID + ":textures/armor/starmetal_1.png", 50000000, 100000, 20000, 500, "RPA_boots").cloneStats((ArmorFSB) rpa_helmet);
    ...
    public static final Item fau_helmet = new ArmorDigamma(MaterialRegistry.aMatFau, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/starmetal_1.png", 100000000, 100000, 25000, 1000, "fau_helmet")
            ...
            .addResistance("monoxide", 0F)
            .setFireproof(true);
    public static final Item fau_plate = new ArmorDigamma(MaterialRegistry.aMatFau, -1, EntityEquipmentSlot.CHEST, Tags.MODID + ":textures/armor/starmetal_1.png", 100000000, 100000, 25000, 1000, "fau_plate").cloneStats((ArmorFSB) fau_helmet).setFullSetForHide();
    public static final Item fau_legs = new ArmorDigamma(MaterialRegistry.aMatFau, -1, EntityEquipmentSlot.LEGS, Tags.MODID + ":textures/armor/starmetal_2.png", 100000000, 100000, 25000, 1000, "fau_legs").cloneStats((ArmorFSB) fau_helmet).setHides(IArmorDisableModel.EnumPlayerPart.LEFT_LEG, IArmorDisableModel.EnumPlayerPart.RIGHT_LEG).setFullSetForHide();
    public static final Item fau_boots = new ArmorDigamma(MaterialRegistry.aMatFau, -1, EntityEquipmentSlot.FEET, Tags.MODID + ":textures/armor/starmetal_1.png", 100000000, 100000, 25000, 1000, "fau_boots").cloneStats((ArmorFSB) fau_helmet);
    public static final Item dns_helmet = new ArmorDNT(MaterialRegistry.aMatDNS, -1, EntityEquipmentSlot.HEAD, Tags.MODID + ":textures/armor/starmetal_1.png", 1000000000, 1000000, 100000, 10000, "dns_helmet")
            ...
            .setHasHardLanding(true)
            .setHides(IArmorDisableModel.EnumPlayerPart.HAT)
            .setHazardClass(ArmorUtil.FULL_PACKAGE).setRadResist(6D /*99.9999%*/)
            .setStep(HBMSoundHandler.iron)
            .setJump(HBMSoundHandler.ironJump)
            .setFall(HBMSoundHandler.ironLand)
            .setFireproof(true);
    public static final Item dns_plate = new ArmorDNT(MaterialRegistry.aMatDNS, -1, EntityEquipmentSlot.CHEST, Tags.MODID + ":textures/armor/starmetal_1.png", 1000000000, 1000000, 100000, 10000, "dns_plate").cloneStats((ArmorFSB) dns_helmet);
    public static final Item dns_legs = new ArmorDNT(MaterialRegistry.aMatDNS, -1, EntityEquipmentSlot.LEGS, Tags.MODID + ":textures/armor/starmetal_2.png", 1000000000, 1000000, 100000, 10000, "dns_legs").cloneStats((ArmorFSB) dns_helmet);
    public static final Item dns_boots = new ArmorDNT(MaterialRegistry.aMatDNS, -1, EntityEquipmentSlot.FEET, Tags.MODID + ":textures/armor/starmetal_1.png", 1000000000, 1000000, 100000, 10000, "dns_boots").cloneStats((ArmorFSB) dns_helmet);
    ...
    public static final Item alloy_sword = new ItemSwordAbility(9F, 0, MaterialRegistry.enumToolMaterialAlloy, "alloy_sword")
            .addAbility(IWeaponAbility.STUN, 2);
    public static final Item alloy_pickaxe = new ItemToolAbility(6F, -2.8F, 0, MaterialRegistry.enumToolMaterialAlloy, EnumToolType.PICKAXE, "alloy_pickaxe")
    ...
    public static final Item alloy_axe = new ItemToolAbility(7F, -2.8F, 0, MaterialRegistry.enumToolMaterialAlloy, EnumToolType.AXE, "alloy_axe")
            .addAbility(IToolAreaAbility.RECURSION, 1)
            .addAbility(IWeaponAbility.BEHEADER, 0);
    public static final Item alloy_shovel = new ItemToolAbility(5F, -2.8F, 0, MaterialRegistry.enumToolMaterialAlloy, EnumToolType.SHOVEL, "alloy_shovel")
            .addAbility(IToolAreaAbility.RECURSION, 1);
    ...
    public static final Item elec_sword = new ItemSwordAbilityPower(15F, 0, MaterialRegistry.enumToolMaterialElec, 500000, 1000, 100, "elec_sword")
            .addAbility(IWeaponAbility.STUN, 5);
    ...
    public static final Item elec_axe = new ItemToolAbilityPower(12.5F, -2.8F, 0, MaterialRegistry.enumToolMaterialElec, EnumToolType.AXE, 500000, 1000, 100, "elec_axe")
            .addAbility(IToolAreaAbility.HAMMER, 1)
            .addAbility(IToolAreaAbility.HAMMER_FLAT, 1)
            .addAbility(IToolAreaAbility.RECURSION, 3)
            .addAbility(IToolHarvestAbility.SILK, 0)
    ...
    public static final Item cmb_sword = new ItemSwordAbility(50F, 0, MaterialRegistry.enumToolMaterialCmb, "cmb_sword")
            .addAbility(IWeaponAbility.STUN, 0)
    ...
    public static final Item cmb_axe = new ItemToolAbility(12.5F, -2.8F, 0, MaterialRegistry.enumToolMaterialCmb, EnumToolType.AXE, "cmb_axe")
            .addAbility(IToolAreaAbility.RECURSION, 3)
            .addAbility(IToolHarvestAbility.SMELTER, 0)
            .addAbility(IToolHarvestAbility.SILK, 0)
            .addAbility(IToolHarvestAbility.LUCK, 3)
    ...
    public static final Item schrabidium_sword = new ItemSwordAbility(150F, 0, MaterialRegistry.enumToolMaterialSchrabidium, "schrabidium_sword")
    ...
    public static final Item schrabidium_pickaxe = new ItemToolAbility(20, -2.8F, 0, MaterialRegistry.enumToolMaterialSchrabidium, EnumToolType.PICKAXE, "schrabidium_pickaxe")
            ...
            .addAbility(IToolAreaAbility.HAMMER, 1)
            .addAbility(IToolAreaAbility.HAMMER_FLAT, 1)
            .addAbility(IToolAreaAbility.RECURSION, 7)
            .addAbility(IToolHarvestAbility.SILK, 0)
            .addAbility(IToolHarvestAbility.LUCK, 4)
            .addAbility(IToolHarvestAbility.SMELTER, 0)
            .addAbility(IToolHarvestAbility.SHREDDER, 0)
    ...
    public static final Item meteorite_sword_seared = new ItemSwordMeteorite(14F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_seared");
    public static final Item meteorite_sword_reforged = new ItemSwordMeteorite(24F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_reforged");
    public static final Item meteorite_sword_hardened = new ItemSwordMeteorite(34F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_hardened");
    public static final Item meteorite_sword_alloyed = new ItemSwordMeteorite(49F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_alloyed");
    public static final Item meteorite_sword_machined = new ItemSwordMeteorite(64F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_machined");
    public static final Item meteorite_sword_treated = new ItemSwordMeteorite(79F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_treated");
    public static final Item meteorite_sword_etched = new ItemSwordMeteorite(99F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_etched");
    public static final Item meteorite_sword_bred = new ItemSwordMeteorite(124F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_bred");
    public static final Item meteorite_sword_irradiated = new ItemSwordMeteorite(174F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_irradiated");
    public static final Item meteorite_sword_fused = new ItemSwordMeteorite(249F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_fused");
    public static final Item meteorite_sword_baleful = new ItemSwordMeteorite(499F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_baleful");
    public static final Item meteorite_sword_warped = new ItemSwordMeteorite(2999F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_warped");
    public static final Item meteorite_sword_demonic = new ItemSwordMeteorite(13665F, 0, MaterialRegistry.matMeteorite, "meteorite_sword_demonic");
    ...
    public static final Item template_folder = new ItemTemplateFolder("template_folder").setCreativeTab(MainRegistry.templateTab);
    // TODO: implment this
    ...
    public static final Item ammo_dgk = new ItemEEAmmo("ammo_dgk").setCreativeTab(MainRegistry.weaponTab);
    ...
    // Extended Edition Priority Custom Items
    public static final Item laser_crystal_nano = new ItemFELCrystal(com.hbm.items.machine.ItemFELCrystal.EnumWavelengths.RADIO, "laser_crystal_nano").setCreativeTab(com.hbm.main.MainRegistry.controlTab);
    public static final Item laser_crystal_pentacene = new ItemFELCrystal(com.hbm.items.machine.ItemFELCrystal.EnumWavelengths.MICRO, "laser_crystal_pentacene").setCreativeTab(com.hbm.main.MainRegistry.controlTab);
    public static final Item laser_crystal_dem = new ItemFELCrystal(com.hbm.items.machine.ItemFELCrystal.EnumWavelengths.XRAY, "laser_crystal_dem").setCreativeTab(com.hbm.main.MainRegistry.controlTab);
    
    public static final Item gun_revolver_schrabidium = new com.hbm.items.weapon.ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverSchrabidiumConfig(), "gun_revolver_schrabidium").setMaxDamage(20000).setCreativeTab(com.hbm.main.MainRegistry.weaponTab);
    public static final Item gun_revolver_schrabidium_ammo = new ItemCustomLore("gun_revolver_schrabidium_ammo").setCreativeTab(com.hbm.main.MainRegistry.weaponTab);
    public static final Item clip_revolver_schrabidium = new ItemClip("clip_revolver_schrabidium", () -> new ItemStack(ModItems.gun_revolver_schrabidium_ammo, 12)).setCreativeTab(com.hbm.main.MainRegistry.weaponTab);

    // Extended Edition Auto-Ported Items
    public static final Item alloy_shield = new com.hbm.items.gear.ModShield("alloy_shield", com.hbm.main.MaterialRegistry.enumToolMaterialAlloy, com.hbm.inventory.OreDictManager.ALLOY.ingot());
    public static final Item ammo_12gauge = new ItemEEAmmo("ammo_12gauge").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_12gauge_du = new ItemEEAmmo("ammo_12gauge_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_12gauge_incendiary = new ItemEEAmmo("ammo_12gauge_incendiary").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_12gauge_marauder = new ItemEEAmmo("ammo_12gauge_marauder").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_12gauge_shrapnel = new ItemEEAmmo("ammo_12gauge_shrapnel").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_12gauge_sleek = new ItemEEAmmo("ammo_12gauge_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge = new ItemEEAmmo("ammo_20gauge").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_caustic = new ItemEEAmmo("ammo_20gauge_caustic").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_explosive = new ItemEEAmmo("ammo_20gauge_explosive").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_flechette = new ItemEEAmmo("ammo_20gauge_flechette").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_incendiary = new ItemEEAmmo("ammo_20gauge_incendiary").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_shock = new ItemEEAmmo("ammo_20gauge_shock").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_shrapnel = new ItemEEAmmo("ammo_20gauge_shrapnel").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_sleek = new ItemEEAmmo("ammo_20gauge_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_slug = new ItemEEAmmo("ammo_20gauge_slug").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_20gauge_wither = new ItemEEAmmo("ammo_20gauge_wither").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_22lr = new ItemEEAmmo("ammo_22lr").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_22lr_ap = new ItemEEAmmo("ammo_22lr_ap").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_22lr_chlorophyte = new ItemEEAmmo("ammo_22lr_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_357_desh = new ItemEEAmmo("ammo_357_desh").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44 = new ItemEEAmmo("ammo_44").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_ap = new ItemEEAmmo("ammo_44_ap").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_bj = new ItemEEAmmo("ammo_44_bj").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_chlorophyte = new ItemEEAmmo("ammo_44_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_du = new ItemEEAmmo("ammo_44_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_phosphorus = new ItemEEAmmo("ammo_44_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_pip = new ItemEEAmmo("ammo_44_pip").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_rocket = new ItemEEAmmo("ammo_44_rocket").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_silver = new ItemEEAmmo("ammo_44_silver").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_44_star = new ItemEEAmmo("ammo_44_star").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge = new ItemEEAmmo("ammo_4gauge").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_balefire = new ItemEEAmmo("ammo_4gauge_balefire").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_canister = new ItemEEAmmo("ammo_4gauge_canister").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_claw = new ItemEEAmmo("ammo_4gauge_claw").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_explosive = new ItemEEAmmo("ammo_4gauge_explosive").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_flechette = new ItemEEAmmo("ammo_4gauge_flechette").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_flechette_phosphorus = new ItemEEAmmo("ammo_4gauge_flechette_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_kampf = new ItemEEAmmo("ammo_4gauge_kampf").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_semtex = new ItemEEAmmo("ammo_4gauge_semtex").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_sleek = new ItemEEAmmo("ammo_4gauge_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_slug = new ItemEEAmmo("ammo_4gauge_slug").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_vampire = new ItemEEAmmo("ammo_4gauge_vampire").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_4gauge_void = new ItemEEAmmo("ammo_4gauge_void").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50ae = new ItemEEAmmo("ammo_50ae").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50ae_ap = new ItemEEAmmo("ammo_50ae_ap").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50ae_chlorophyte = new ItemEEAmmo("ammo_50ae_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50ae_du = new ItemEEAmmo("ammo_50ae_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50ae_star = new ItemEEAmmo("ammo_50ae_star").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg = new ItemEEAmmo("ammo_50bmg").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_ap = new ItemEEAmmo("ammo_50bmg_ap").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_chlorophyte = new ItemEEAmmo("ammo_50bmg_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_du = new ItemEEAmmo("ammo_50bmg_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_explosive = new ItemEEAmmo("ammo_50bmg_explosive").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_flechette = new ItemEEAmmo("ammo_50bmg_flechette").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_flechette_am = new ItemEEAmmo("ammo_50bmg_flechette_am").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_flechette_po = new ItemEEAmmo("ammo_50bmg_flechette_po").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_incendiary = new ItemEEAmmo("ammo_50bmg_incendiary").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_phosphorus = new ItemEEAmmo("ammo_50bmg_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_sleek = new ItemEEAmmo("ammo_50bmg_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_50bmg_star = new ItemEEAmmo("ammo_50bmg_star").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556 = new ItemEEAmmo("ammo_556").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_ap = new ItemEEAmmo("ammo_556_ap").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_chlorophyte = new ItemEEAmmo("ammo_556_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_du = new ItemEEAmmo("ammo_556_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_flechette = new ItemEEAmmo("ammo_556_flechette").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_flechette_chlorophyte = new ItemEEAmmo("ammo_556_flechette_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_flechette_du = new ItemEEAmmo("ammo_556_flechette_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_flechette_incendiary = new ItemEEAmmo("ammo_556_flechette_incendiary").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_flechette_phosphorus = new ItemEEAmmo("ammo_556_flechette_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_flechette_sleek = new ItemEEAmmo("ammo_556_flechette_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_k = new ItemEEAmmo("ammo_556_k").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_phosphorus = new ItemEEAmmo("ammo_556_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_sleek = new ItemEEAmmo("ammo_556_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_star = new ItemEEAmmo("ammo_556_star").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_556_tracer = new ItemEEAmmo("ammo_556_tracer").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_566_gold = new ItemCustomLore("gun_mp_ammo").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_5mm = new ItemEEAmmo("ammo_5mm").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_5mm_chlorophyte = new ItemEEAmmo("ammo_5mm_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_5mm_du = new ItemEEAmmo("ammo_5mm_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_5mm_explosive = new ItemEEAmmo("ammo_5mm_explosive").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_5mm_star = new ItemEEAmmo("ammo_5mm_star").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_75bolt = new ItemEEAmmo("ammo_75bolt").setMaxStackSize(8).setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_75bolt_he = new ItemEEAmmo("ammo_75bolt_he").setMaxStackSize(8).setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_75bolt_incendiary = new ItemEEAmmo("ammo_75bolt_incendiary").setMaxStackSize(8).setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_9mm = new ItemEEAmmo("ammo_9mm").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_9mm_ap = new ItemEEAmmo("ammo_9mm_ap").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_9mm_chlorophyte = new ItemEEAmmo("ammo_9mm_chlorophyte").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_9mm_du = new ItemEEAmmo("ammo_9mm_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_9mm_rocket = new ItemEEAmmo("ammo_9mm_rocket").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_dart = new ItemEEAmmo("ammo_dart").setMaxStackSize(16).setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_folly = new ItemEEAmmo("ammo_folly").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_folly_du = new ItemEEAmmo("ammo_folly_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_folly_nuclear = new ItemEEAmmo("ammo_folly_nuclear").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_fuel = new ItemEEAmmo("ammo_fuel").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_fuel_gas = new ItemEEAmmo("ammo_fuel_gas").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_fuel_napalm = new ItemEEAmmo("ammo_fuel_napalm").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_fuel_phosphorus = new ItemEEAmmo("ammo_fuel_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_fuel_vaporizer = new ItemEEAmmo("ammo_fuel_vaporizer").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade = new ItemEEAmmo("ammo_grenade").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_concussion = new ItemEEAmmo("ammo_grenade_concussion").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_finned = new ItemEEAmmo("ammo_grenade_finned").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_he = new ItemEEAmmo("ammo_grenade_he").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_incendiary = new ItemEEAmmo("ammo_grenade_incendiary").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_kampf = new ItemEEAmmo("ammo_grenade_kampf").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_nuclear = new ItemEEAmmo("ammo_grenade_nuclear").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_phosphorus = new ItemEEAmmo("ammo_grenade_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_sleek = new ItemEEAmmo("ammo_grenade_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_toxic = new ItemEEAmmo("ammo_grenade_toxic").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_grenade_tracer = new ItemEEAmmo("ammo_grenade_tracer").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_mirv = new ItemEEAmmo("ammo_mirv").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_mirv_high = new ItemEEAmmo("ammo_mirv_high").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_mirv_low = new ItemEEAmmo("ammo_mirv_low").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_mirv_safe = new ItemEEAmmo("ammo_mirv_safe").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_mirv_special = new ItemEEAmmo("ammo_mirv_special").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_nuke = new ItemEEAmmo("ammo_nuke").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_nuke_high = new ItemEEAmmo("ammo_nuke_high").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_nuke_low = new ItemEEAmmo("ammo_nuke_low").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_nuke_pumpkin = new ItemEEAmmo("ammo_nuke_pumpkin").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_nuke_safe = new ItemEEAmmo("ammo_nuke_safe").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_nuke_tots = new ItemEEAmmo("ammo_nuke_tots").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket = new ItemEEAmmo("ammo_rocket").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_canister = new ItemEEAmmo("ammo_rocket_canister").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_emp = new ItemEEAmmo("ammo_rocket_emp").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_glare = new ItemEEAmmo("ammo_rocket_glare").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_he = new ItemEEAmmo("ammo_rocket_he").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_incendiary = new ItemEEAmmo("ammo_rocket_incendiary").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_nuclear = new ItemEEAmmo("ammo_rocket_nuclear").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_phosphorus = new ItemEEAmmo("ammo_rocket_phosphorus").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_rpc = new ItemEEAmmo("ammo_rocket_rpc").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_shrapnel = new ItemEEAmmo("ammo_rocket_shrapnel").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_sleek = new ItemEEAmmo("ammo_rocket_sleek").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_rocket_toxic = new ItemEEAmmo("ammo_rocket_toxic").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_shell_apfsds_du = new ItemEEAmmo("ammo_shell_apfsds_du").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_shell_apfsds_t = new ItemEEAmmo("ammo_shell_apfsds_t").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_shell_explosive = new ItemEEAmmo("ammo_shell_explosive").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ammo_shell_w9 = new ItemEEAmmo("ammo_shell_w9").setCreativeTab(MainRegistry.weaponTab);
    public static final Item ams_focus_blank = new ItemBase("ams_focus_blank").setCreativeTab(MainRegistry.partsTab);
    public static final Item ams_focus_booster = new ItemBase("ams_focus_booster").setCreativeTab(MainRegistry.partsTab);
    public static final Item ams_focus_limiter = new ItemBase("ams_focus_limiter").setCreativeTab(MainRegistry.partsTab);
    public static final Item ams_focus_omega = new ItemBase("ams_focus_omega").setCreativeTab(MainRegistry.partsTab);
    public static final Item antiknock = new ItemBase("antiknock").setCreativeTab(MainRegistry.partsTab);
    public static final Item arc_electrode_desh = new ItemCustomLore("arc_electrode_desh").setCreativeTab(MainRegistry.partsTab);
    public static final Item armor_battery_mk4 = new ItemBase("armor_battery_mk4").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item assembly_template = new ItemBase("assembly_template").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item bathwater_mk3 = new ItemBase("bathwater_mk3").setCreativeTab(MainRegistry.partsTab);
    public static final Item battery_steam = new ItemBase("battery_steam").setCreativeTab(MainRegistry.partsTab);
    public static final Item battery_steam_large = new ItemBase("battery_steam_large").setCreativeTab(MainRegistry.partsTab);
    public static final Item battery_su = new ItemBase("battery_su").setCreativeTab(MainRegistry.partsTab);
    public static final Item battery_su_l = new ItemBase("battery_su_l").setCreativeTab(MainRegistry.partsTab);
    public static final Item billet_ac227 = new ItemCustomLore("billet_ac227").setCreativeTab(MainRegistry.partsTab);
    public static final Item blades_aluminum = new ItemBase("blades_aluminum").setCreativeTab(MainRegistry.partsTab);
    public static final Item blades_combine_steel = new ItemBase("blades_combine_steel").setCreativeTab(MainRegistry.partsTab);
    public static final Item blades_gold = new ItemBase("blades_gold").setCreativeTab(MainRegistry.partsTab);
    public static final Item blades_iron = new ItemBase("blades_iron").setCreativeTab(MainRegistry.partsTab);
    public static final Item blades_schrabidium = new ItemBase("blades_schrabidium").setCreativeTab(MainRegistry.partsTab);
    public static final Item bob_assembly = new ItemBase("bob_assembly").setCreativeTab(MainRegistry.partsTab);
    public static final Item bob_chemistry = new ItemBase("bob_chemistry").setCreativeTab(MainRegistry.partsTab);
    public static final Item bob_metalworks = new ItemBase("bob_metalworks").setCreativeTab(MainRegistry.partsTab);
    public static final Item bob_nuclear = new ItemBase("bob_nuclear").setCreativeTab(MainRegistry.partsTab);
    public static final Item bob_oil = new ItemBase("bob_oil").setCreativeTab(MainRegistry.partsTab);
    public static final Item bobmazon_machines = new ItemBase("bobmazon_machines").setCreativeTab(MainRegistry.partsTab);
    public static final Item bobmazon_materials = new ItemBase("bobmazon_materials").setCreativeTab(MainRegistry.partsTab);
    public static final Item bobmazon_tools = new ItemBase("bobmazon_tools").setCreativeTab(MainRegistry.partsTab);
    public static final Item bobmazon_weapons = new ItemBase("bobmazon_weapons").setCreativeTab(MainRegistry.partsTab);
    public static final Item briquette_lignite = new ItemBase("briquette_lignite").setCreativeTab(MainRegistry.partsTab);
    public static final Item canned_asbestos = new ItemBase("canned_asbestos").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_ass = new ItemBase("canned_ass").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_bark = new ItemBase("canned_bark").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_beef = new ItemBase("canned_beef").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_bhole = new ItemBase("canned_bhole").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_cheese = new ItemBase("canned_cheese").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_chinese = new ItemBase("canned_chinese").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_diesel = new ItemBase("canned_diesel").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_fist = new ItemBase("canned_fist").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_fried = new ItemBase("canned_fried").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_hotdogs = new ItemBase("canned_hotdogs").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_jizz = new ItemBase("canned_jizz").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_kerosene = new ItemBase("canned_kerosene").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_leftovers = new ItemBase("canned_leftovers").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_milk = new ItemBase("canned_milk").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_mystery = new ItemBase("canned_mystery").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_napalm = new ItemBase("canned_napalm").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_oil = new ItemBase("canned_oil").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_pashtet = new ItemBase("canned_pashtet").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_pizza = new ItemBase("canned_pizza").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_recursion = new ItemBase("canned_recursion").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_spam = new ItemBase("canned_spam").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_stew = new ItemBase("canned_stew").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_tomato = new ItemBase("canned_tomato").setCreativeTab(MainRegistry.consumableTab);
    public static final Item canned_tube = new ItemBase("canned_tube").setCreativeTab(MainRegistry.consumableTab);
    ...
    public static final Item cladding_di = new ItemBase("cladding_di").setCreativeTab(MainRegistry.partsTab);
    public static final Item cladding_electronium = new ItemBase("cladding_electronium").setCreativeTab(MainRegistry.partsTab);
    public static final Item cladding_euphemium = new ItemBase("cladding_euphemium").setCreativeTab(MainRegistry.partsTab);
    public static final Item cladding_paa = new ItemBase("cladding_paa").setCreativeTab(MainRegistry.partsTab);
    public static final Item clip_bf = new ItemClip("clip_bf", () -> new ItemStack(ModItems.gun_bf_ammo, 2)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_bolt_action = new ItemClip("clip_bolt_action", () -> new ItemStack(ModItems.ammo_20gauge_slug, 24)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_cryolator = new ItemClip("clip_cryolator", () -> new ItemStack(ModItems.gun_cryolator_ammo, 64)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_defabricator = new ItemClip("clip_defabricator", () -> new ItemStack(ModItems.gun_defabricator_ammo, 16)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_emp = new ItemClip("clip_emp", () -> new ItemStack(ModItems.gun_emp_ammo, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_euthanasia = new ItemClip("clip_euthanasia", () -> new ItemStack(ModItems.gun_euthanasia_ammo, 16)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_fatman = new ItemClip("clip_fatman", () -> new ItemStack(ModItems.ammo_nuke, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_hp = new ItemClip("clip_hp", () -> new ItemStack(ModItems.gun_hp_ammo, 12)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_immolator = new ItemClip("clip_immolator", () -> new ItemStack(ModItems.gun_immolator_ammo, 64)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_jack = new ItemClip("clip_jack", () -> new ItemStack(ModItems.gun_jack_ammo, 12)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_lever_action = new ItemClip("clip_lever_action", () -> new ItemStack(ModItems.ammo_20gauge, 24)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_mirv = new ItemClip("clip_mirv", () -> new ItemStack(ModItems.ammo_mirv, 3)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_mp = new ItemClip("clip_mp", () -> new ItemStack(ModItems.ammo_566_gold, 40)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_mp40 = new ItemClip("clip_mp40", () -> new ItemStack(ModItems.ammo_9mm, 32)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_osipr = new ItemClip("clip_osipr", () -> new ItemStack(ModItems.gun_osipr_ammo, 30)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver = new ItemClip("clip_revolver", () -> new ItemStack(ModItems.gun_revolver_ammo, 12)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_cursed = new ItemClip("clip_revolver_cursed", () -> new ItemStack(ModItems.gun_revolver_cursed_ammo, 17)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_gold = new ItemClip("clip_revolver_gold", () -> new ItemStack(ModItems.gun_revolver_gold_ammo, 12)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_iron = new ItemClip("clip_revolver_iron", () -> new ItemStack(ModItems.gun_revolver_iron_ammo, 24)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_lead = new ItemClip("clip_revolver_lead", () -> new ItemStack(ModItems.gun_revolver_lead_ammo, 12)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_nightmare = new ItemClip("clip_revolver_nightmare", () -> new ItemStack(ModItems.gun_revolver_nightmare_ammo, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_nightmare2 = new ItemClip("clip_revolver_nightmare2", () -> new ItemStack(ModItems.gun_revolver_nightmare2_ammo, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_nopip = new ItemClip("clip_revolver_nopip", () -> new ItemStack(ModItems.ammo_44, 12)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_revolver_pip = new ItemClip("clip_revolver_pip", () -> new ItemStack(ModItems.ammo_44_pip, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_rpg = new ItemClip("clip_rpg", () -> new ItemStack(ModItems.ammo_rocket, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_spark = new ItemClip("clip_spark", () -> new ItemStack(ModItems.gun_spark_ammo, 4)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_stinger = new ItemClip("clip_stinger", () -> new ItemStack(ModItems.gun_stinger_ammo, 6)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_uboinik = new ItemClip("clip_uboinik", () -> new ItemStack(ModItems.ammo_12gauge, 24)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_uzi = new ItemClip("clip_uzi", () -> new ItemStack(ModItems.ammo_22lr, 32)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item clip_xvl1456 = new ItemClip("clip_xvl1456", () -> new ItemStack(ModItems.gun_xvl1456_ammo, 64)).setCreativeTab(MainRegistry.weaponTab);
    public static final Item cmb_shield = new com.hbm.items.gear.ModShield("cmb_shield", com.hbm.main.MaterialRegistry.enumToolMaterialCmb, com.hbm.inventory.OreDictManager.CMB.ingot());
    public static final Item cobalt_shield = new com.hbm.items.gear.ModShield("cobalt_shield", com.hbm.main.MaterialRegistry.enumToolMaterialCobalt, com.hbm.inventory.OreDictManager.CO.ingot());
    public static final Item coltass = new ItemBase("coltass").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item crucible_template = new ItemCrucibleTemplate("crucible_template").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item decontamination_module = new ItemBase("decontamination_module").setCreativeTab(MainRegistry.partsTab);
    public static final Item desh_shield = new com.hbm.items.gear.ModShield("desh_shield", com.hbm.main.MaterialRegistry.enumToolMaterialDesh, com.hbm.inventory.OreDictManager.DESH.ingot());
    public static final Item digamma_feel = new ItemBase("digamma_feel").setCreativeTab(MainRegistry.partsTab);
    public static final Item digamma_kauai_moho = new ItemBase("digamma_kauai_moho").setCreativeTab(MainRegistry.partsTab);
    public static final Item digamma_know = new ItemBase("digamma_know").setCreativeTab(MainRegistry.partsTab);
    public static final Item digamma_see = new ItemBase("digamma_see").setCreativeTab(MainRegistry.partsTab);
    public static final Item digamma_up_on_top = new ItemBase("digamma_up_on_top").setCreativeTab(MainRegistry.partsTab);
    public static final Item drillbit_desh = new ItemBase("drillbit_desh").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_desh_diamond = new ItemBase("drillbit_desh_diamond").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_dnt = new ItemBase("drillbit_dnt").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_dnt_diamond = new ItemBase("drillbit_dnt_diamond").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_ferro = new ItemBase("drillbit_ferro").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_ferro_diamond = new ItemBase("drillbit_ferro_diamond").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_hss = new ItemBase("drillbit_hss").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_hss_diamond = new ItemBase("drillbit_hss_diamond").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_steel = new ItemBase("drillbit_steel").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_steel_diamond = new ItemBase("drillbit_steel_diamond").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_tcalloy = new ItemBase("drillbit_tcalloy").setCreativeTab(MainRegistry.controlTab);
    public static final Item drillbit_tcalloy_diamond = new ItemBase("drillbit_tcalloy_diamond").setCreativeTab(MainRegistry.controlTab);
    public static final Item elec_shield = new com.hbm.items.gear.ModShield("elec_shield", 450, com.hbm.inventory.OreDictManager.POLYMER.ingot());
    public static final Item energy_ball = new ItemBase("energy_ball").setCreativeTab(MainRegistry.partsTab);
    public static final Item factory_core_advanced = new ItemCustomLore("factory_core_advanced").setCreativeTab(MainRegistry.partsTab);
    public static final Item factory_core_titanium = new ItemCustomLore("factory_core_titanium").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item forge_fluid_identifier = new ItemBase("forge_fluid_identifier").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas1 = new ItemBase("gas1").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas2 = new ItemBase("gas2").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas3 = new ItemBase("gas3").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas4 = new ItemBase("gas4").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas5 = new ItemBase("gas5").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas6 = new ItemBase("gas6").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas7 = new ItemBase("gas7").setCreativeTab(MainRegistry.partsTab);
    public static final Item gas8 = new ItemBase("gas8").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item gas_sensor = new ItemBase("gas_sensor").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame1 = new ItemBase("gasflame1").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame2 = new ItemBase("gasflame2").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame3 = new ItemBase("gasflame3").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame4 = new ItemBase("gasflame4").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame5 = new ItemBase("gasflame5").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame6 = new ItemBase("gasflame6").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame7 = new ItemBase("gasflame7").setCreativeTab(MainRegistry.partsTab);
    public static final Item gasflame8 = new ItemBase("gasflame8").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item gun_ar15 = new ItemGunBase(com.hbm.handler.guncfg.Gun50BMGFactory.getAR15Config(), "gun_ar15").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_avenger = new ItemGunLacunae(com.hbm.handler.guncfg.Gun5mmFactory.get57Config(), "gun_avenger").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_bf = new ItemGunBase(com.hbm.handler.guncfg.GunFatmanFactory.getBELConfig(), "gun_bf").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_bf_ammo = new ItemBase("gun_bf_ammo").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_bolt_action = new ItemGunBase(com.hbm.handler.guncfg.Gun20GaugeFactory.getBoltConfig(), "gun_bolt_action").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_bolt_action_green = new ItemGunBase(com.hbm.handler.guncfg.Gun20GaugeFactory.getBoltGreenConfig(), "gun_bolt_action_green").setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_brimstone = new GunBrimstone("gun_brimstone");
    public static final Item gun_calamity = new ItemGunBase(com.hbm.handler.guncfg.Gun50BMGFactory.getCalamityConfig(), "gun_calamity").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_calamity_dual = new ItemGunBase(com.hbm.handler.guncfg.Gun50BMGFactory.getSaddleConfig(), "gun_calamity_dual").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_cryolator = new GunCryolator("gun_cryolator").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_cryolator_ammo = new ItemBase("gun_cryolator_ammo").setCreativeTab(MainRegistry.partsTab);
    public static final Item gun_dampfmaschine = new GunDampfmaschine("gun_dampfmaschine").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_darter = new ItemGunDart(com.hbm.handler.guncfg.GunDartFactory.getDarterConfig(), "gun_darter").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_dash_ammo = new ItemBase("gun_dash_ammo").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item gun_flechette = new ItemGunBase(com.hbm.handler.guncfg.Gun556mmFactory.getSPIWConfig(), com.hbm.handler.guncfg.Gun556mmFactory.getGLauncherConfig(), "gun_flechette").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_hk69 = new ItemGunBase(com.hbm.handler.guncfg.GunGrenadeFactory.getHK69Config(), "gun_hk69").setMaxDamage(300).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_hp = new GunHP("gun_hp").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_hp_ammo = new ItemBase("gun_hp_ammo").setCreativeTab(MainRegistry.partsTab);
    public static final Item gun_immolator = new GunImmolator("gun_immolator").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_immolator_ammo = new ItemBase("gun_immolator_ammo").setCreativeTab(MainRegistry.partsTab);
    public static final Item gun_jack = new GunJack("gun_jack").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_jack_ammo = new ItemBase("gun_jack_ammo").setCreativeTab(MainRegistry.partsTab);
    public static final Item gun_karl = new ItemGunBase(com.hbm.handler.guncfg.GunRocketFactory.getKarlConfig(), "gun_karl").setMaxDamage(500).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_ks23 = new ItemGunBase(com.hbm.handler.guncfg.Gun4GaugeFactory.getKS23Config(), "gun_ks23").setMaxDamage(3000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_lacunae = new ItemGunLacunae(com.hbm.handler.guncfg.Gun5mmFactory.getLacunaeConfig(), "gun_lacunae").setMaxDamage(25000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_lever_action = new ItemGunBase(com.hbm.handler.guncfg.Gun20GaugeFactory.getMareConfig(), "gun_lever_action").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_lever_action_dark = new ItemGunBase(com.hbm.handler.guncfg.Gun20GaugeFactory.getMareDarkConfig(), "gun_lever_action_dark").setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_mirv = new ItemGunBase(com.hbm.handler.guncfg.GunFatmanFactory.getMIRVConfig(), "gun_mirv").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_mp = new ItemGunBase(com.hbm.handler.guncfg.Gun556mmFactory.getEuphieConfig(), "gun_mp").setMaxDamage(10000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_mp40 = new ItemGunBase(com.hbm.handler.guncfg.Gun9mmFactory.getMP40Config(), "gun_mp40").setMaxDamage(2500).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_osipr = new ItemGunOSIPR(com.hbm.handler.guncfg.GunOSIPRFactory.getOSIPRConfig(), com.hbm.handler.guncfg.GunOSIPRFactory.getAltConfig(), "gun_osipr").setMaxDamage(10000).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_proto = new ItemGunBase(com.hbm.handler.guncfg.GunFatmanFactory.getProtoConfig(), "gun_proto").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverConfig(), "gun_revolver").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_ammo = new ItemBase("gun_revolver_ammo").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_blackjack = new ItemGunBase(com.hbm.handler.guncfg.Gun44MagnumFactory.getBlackjackConfig(), "gun_revolver_blackjack").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_cursed = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverCursedConfig(), "gun_revolver_cursed").setMaxDamage(5000).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_revolver_gold = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverGoldConfig(), "gun_revolver_gold").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_revolver_iron = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverIronConfig(), "gun_revolver_iron").setMaxDamage(100).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_revolver_lead = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverLeadConfig(), "gun_revolver_lead").setMaxDamage(250).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_revolver_nightmare = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverNightmareConfig(), "gun_revolver_nightmare").setMaxDamage(6).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_nightmare2 = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverNightmare2Config(), "gun_revolver_nightmare2").setMaxDamage(6).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item gun_revolver_nopip = new ItemGunBase(com.hbm.handler.guncfg.Gun44MagnumFactory.getNovacConfig(), "gun_revolver_nopip").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_pip = new ItemGunBase(com.hbm.handler.guncfg.Gun44MagnumFactory.getMacintoshConfig(), "gun_revolver_pip").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_red = new ItemGunBase(com.hbm.handler.guncfg.Gun44MagnumFactory.getRedConfig(), "gun_revolver_red").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_saturnite = new ItemGunBase(com.hbm.handler.guncfg.Gun357MagnumFactory.getRevolverSaturniteConfig(), "gun_revolver_saturnite").setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_revolver_silver = new ItemGunBase(com.hbm.handler.guncfg.Gun44MagnumFactory.getSilverConfig(), "gun_revolver_silver").setMaxDamage(1000).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_rpg = new ItemGunBase(com.hbm.handler.guncfg.GunRocketFactory.getGustavConfig(), "gun_rpg").setMaxDamage(140).setCreativeTab(MainRegistry.weaponTab);
    public static final Item gun_sauer = new ItemGunBase(com.hbm.handler.guncfg.Gun4GaugeFactory.getSauerConfig(), "gun_sauer").setMaxDamage(3000).setCreativeTab(MainRegistry.weaponTab);
    ...
    public static final Item inf_water_mk3 = new ItemBase("inf_water_mk3").setCreativeTab(MainRegistry.partsTab);
    public static final Item inf_water_mk4 = new ItemBase("inf_water_mk4").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item insert_di = new ItemBase("insert_di").setCreativeTab(MainRegistry.partsTab);
    public static final Item insert_ferrouranium = new ItemBase("insert_ferrouranium").setCreativeTab(MainRegistry.partsTab);
    public static final Item low_density_element = new ItemBase("low_density_element").setCreativeTab(MainRegistry.partsTab);
    public static final Item medal_ghoul = new ItemBase("medal_ghoul").setCreativeTab(MainRegistry.partsTab);
    public static final Item missile_soyuz0 = new ItemBase("missile_soyuz0").setCreativeTab(MainRegistry.partsTab);
    public static final Item missile_soyuz1 = new ItemBase("missile_soyuz1").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item ore_bedrock = new ItemBase("ore_bedrock").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_centrifuged = new ItemBase("ore_bedrock_centrifuged").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_cleaned = new ItemBase("ore_bedrock_cleaned").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_deepcleaned = new ItemBase("ore_bedrock_deepcleaned").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_enriched = new ItemBase("ore_bedrock_enriched").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_exquisite = new ItemBase("ore_bedrock_exquisite").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_nitrated = new ItemBase("ore_bedrock_nitrated").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_nitrocrystalline = new ItemBase("ore_bedrock_nitrocrystalline").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_perfect = new ItemBase("ore_bedrock_perfect").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_purified = new ItemBase("ore_bedrock_purified").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_seared = new ItemBase("ore_bedrock_seared").setCreativeTab(MainRegistry.partsTab);
    public static final Item ore_bedrock_separated = new ItemBase("ore_bedrock_separated").setCreativeTab(MainRegistry.partsTab);
    public static final Item pellet_mercury = new ItemCustomLore("pellet_mercury").setCreativeTab(MainRegistry.partsTab);
    public static final Item pellet_rtg_depleted_bismuth = new ItemCustomLore("pellet_rtg_depleted_bismuth").setCreativeTab(MainRegistry.partsTab);
    public static final Item pellet_rtg_depleted_lead = new ItemCustomLore("pellet_rtg_depleted_lead").setCreativeTab(MainRegistry.partsTab);
    public static final Item pellet_rtg_depleted_mercury = new ItemCustomLore("pellet_rtg_depleted_mercury").setCreativeTab(MainRegistry.partsTab);
    public static final Item pellet_rtg_depleted_neptunium = new ItemCustomLore("pellet_rtg_depleted_neptunium").setCreativeTab(MainRegistry.partsTab);
    public static final Item pellet_rtg_depleted_zirconium = new ItemCustomLore("pellet_rtg_depleted_zirconium").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item pocket_ptsd = new ItemBase("pocket_ptsd").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item rod_ac227 = new ItemCustomLore("rod_ac227").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_australium = new ItemCustomLore("rod_australium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_balefire = new ItemCustomLore("rod_balefire").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_balefire_blazing = new ItemCustomLore("rod_balefire_blazing").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_co60 = new ItemCustomLore("rod_co60").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_cobalt = new ItemBase("rod_cobalt").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_coolant = new ItemCustomLore("rod_coolant").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_daffergon = new ItemCustomLore("rod_daffergon").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_ac227 = new ItemCustomLore("rod_dual_ac227").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_balefire = new ItemCustomLore("rod_dual_balefire").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_balefire_blazing = new ItemCustomLore("rod_dual_balefire_blazing").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_co60 = new ItemCustomLore("rod_dual_co60").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_cobalt = new ItemBase("rod_dual_cobalt").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_coolant = new ItemCustomLore("rod_dual_coolant").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_lead = new ItemBase("rod_dual_lead").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_lithium = new ItemCustomLore("rod_dual_lithium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_mox_fuel = new ItemBase("rod_dual_mox_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_dual_mox_fuel_depleted = new ItemCustomLore("rod_dual_mox_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_neptunium = new ItemCustomLore("rod_dual_neptunium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_plutonium = new ItemCustomLore("rod_dual_plutonium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_plutonium_fuel = new ItemBase("rod_dual_plutonium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_dual_plutonium_fuel_depleted = new ItemCustomLore("rod_dual_plutonium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_polonium = new ItemCustomLore("rod_dual_polonium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_pu238 = new ItemCustomLore("rod_dual_pu238").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_pu239 = new ItemCustomLore("rod_dual_pu239").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_pu240 = new ItemCustomLore("rod_dual_pu240").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_ra226 = new ItemCustomLore("rod_dual_ra226").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_rgp = new ItemCustomLore("rod_dual_rgp").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_schrabidium = new ItemCustomLore("rod_dual_schrabidium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_schrabidium_fuel = new ItemBase("rod_dual_schrabidium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_dual_schrabidium_fuel_depleted = new ItemCustomLore("rod_dual_schrabidium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_solinium = new ItemCustomLore("rod_dual_solinium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_th232 = new ItemCustomLore("rod_dual_th232").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_thorium_fuel = new ItemBase("rod_dual_thorium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_dual_thorium_fuel_depleted = new ItemCustomLore("rod_dual_thorium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_tritium = new ItemCustomLore("rod_dual_tritium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_u233 = new ItemCustomLore("rod_dual_u233").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_u235 = new ItemCustomLore("rod_dual_u235").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_u238 = new ItemCustomLore("rod_dual_u238").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_uranium = new ItemCustomLore("rod_dual_uranium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_uranium_fuel = new ItemBase("rod_dual_uranium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_dual_uranium_fuel_depleted = new ItemCustomLore("rod_dual_uranium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_waste = new ItemCustomLore("rod_dual_waste").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_dual_water = new ItemCustomLore("rod_dual_water").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_euphemium = new ItemCustomLore("rod_euphemium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_lead = new ItemBase("rod_lead").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_lithium = new ItemCustomLore("rod_lithium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_mox_fuel = new ItemBase("rod_mox_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_mox_fuel_depleted = new ItemCustomLore("rod_mox_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_neptunium = new ItemCustomLore("rod_neptunium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_plutonium = new ItemCustomLore("rod_plutonium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_plutonium_fuel = new ItemBase("rod_plutonium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_plutonium_fuel_depleted = new ItemCustomLore("rod_plutonium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_polonium = new ItemCustomLore("rod_polonium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_pu238 = new ItemCustomLore("rod_pu238").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_pu239 = new ItemCustomLore("rod_pu239").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_pu240 = new ItemCustomLore("rod_pu240").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_ac227 = new ItemCustomLore("rod_quad_ac227").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_balefire = new ItemCustomLore("rod_quad_balefire").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_balefire_blazing = new ItemCustomLore("rod_quad_balefire_blazing").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_co60 = new ItemCustomLore("rod_quad_co60").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_cobalt = new ItemBase("rod_quad_cobalt").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_coolant = new ItemCustomLore("rod_quad_coolant").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_euphemium = new ItemCustomLore("rod_quad_euphemium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_lead = new ItemBase("rod_quad_lead").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_lithium = new ItemCustomLore("rod_quad_lithium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_mox_fuel = new ItemBase("rod_quad_mox_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_quad_mox_fuel_depleted = new ItemCustomLore("rod_quad_mox_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_neptunium = new ItemCustomLore("rod_quad_neptunium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_plutonium = new ItemCustomLore("rod_quad_plutonium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_plutonium_fuel = new ItemBase("rod_quad_plutonium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_quad_plutonium_fuel_depleted = new ItemCustomLore("rod_quad_plutonium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_polonium = new ItemCustomLore("rod_quad_polonium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_pu238 = new ItemCustomLore("rod_quad_pu238").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_pu239 = new ItemCustomLore("rod_quad_pu239").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_pu240 = new ItemCustomLore("rod_quad_pu240").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_ra226 = new ItemCustomLore("rod_quad_ra226").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_rgp = new ItemCustomLore("rod_quad_rgp").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_schrabidium = new ItemCustomLore("rod_quad_schrabidium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_schrabidium_fuel = new ItemBase("rod_quad_schrabidium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_quad_schrabidium_fuel_depleted = new ItemCustomLore("rod_quad_schrabidium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_solinium = new ItemCustomLore("rod_quad_solinium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_th232 = new ItemCustomLore("rod_quad_th232").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_thorium_fuel = new ItemBase("rod_quad_thorium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_quad_thorium_fuel_depleted = new ItemCustomLore("rod_quad_thorium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_tritium = new ItemCustomLore("rod_quad_tritium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_u233 = new ItemCustomLore("rod_quad_u233").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_u235 = new ItemCustomLore("rod_quad_u235").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_u238 = new ItemCustomLore("rod_quad_u238").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_uranium = new ItemCustomLore("rod_quad_uranium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_uranium_fuel = new ItemBase("rod_quad_uranium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_quad_uranium_fuel_depleted = new ItemCustomLore("rod_quad_uranium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_waste = new ItemCustomLore("rod_quad_waste").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_quad_water = new ItemCustomLore("rod_quad_water").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_ra226 = new ItemCustomLore("rod_ra226").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_reiium = new ItemCustomLore("rod_reiium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_rgp = new ItemCustomLore("rod_rgp").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_schrabidium = new ItemCustomLore("rod_schrabidium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_schrabidium_fuel = new ItemBase("rod_schrabidium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_schrabidium_fuel_depleted = new ItemCustomLore("rod_schrabidium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_solinium = new ItemCustomLore("rod_solinium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_th232 = new ItemCustomLore("rod_th232").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_thorium_fuel = new ItemBase("rod_thorium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_thorium_fuel_depleted = new ItemCustomLore("rod_thorium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_tritium = new ItemCustomLore("rod_tritium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_u233 = new ItemCustomLore("rod_u233").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_u235 = new ItemCustomLore("rod_u235").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_u238 = new ItemCustomLore("rod_u238").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_unobtainium = new ItemCustomLore("rod_unobtainium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_uranium = new ItemCustomLore("rod_uranium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_uranium_fuel = new ItemBase("rod_uranium_fuel").setCreativeTab(MainRegistry.controlTab);
    public static final Item rod_uranium_fuel_depleted = new ItemCustomLore("rod_uranium_fuel_depleted").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_verticium = new ItemCustomLore("rod_verticium").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_waste = new ItemCustomLore("rod_waste").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_water = new ItemCustomLore("rod_water").setCreativeTab(MainRegistry.partsTab);
    public static final Item rod_weidanium = new ItemCustomLore("rod_weidanium").setCreativeTab(MainRegistry.partsTab);
    public static final Item schrabidium_shield = new com.hbm.items.gear.ModShield("schrabidium_shield", com.hbm.main.MaterialRegistry.enumToolMaterialSchrabidium, com.hbm.inventory.OreDictManager.SA326.ingot());
    ...
    public static final Item t45_plate = new ArmorT45(MaterialRegistry.enumArmorMaterialT45, -1, EntityEquipmentSlot.CHEST, 1000000, 10000, 1000, 5, "t45_plate").cloneStats((ArmorFSB) t45_helmet).setCreativeTab(CreativeTabs.COMBAT);
    public static final Item t45_legs = new ArmorT45(MaterialRegistry.enumArmorMaterialT45, -1, EntityEquipmentSlot.LEGS, 1000000, 10000, 1000, 5, "t45_legs").cloneStats((ArmorFSB) t45_helmet).setCreativeTab(CreativeTabs.COMBAT);
    public static final Item t45_boots = new ArmorT45(MaterialRegistry.enumArmorMaterialT45, -1, EntityEquipmentSlot.FEET, 1000000, 10000, 1000, 5, "t45_boots").cloneStats((ArmorFSB) t45_helmet).setCreativeTab(CreativeTabs.COMBAT);
    public static final Item tem_flakes1 = new ItemBase("tem_flakes1").setCreativeTab(MainRegistry.partsTab);
    public static final Item tem_flakes2 = new ItemBase("tem_flakes2").setCreativeTab(MainRegistry.partsTab);
    ...
    public static final Item wire = new ItemAutogen(MaterialShapes.WIRE, "wire")
            ...
            .aot(Mats.MAT_ALUMINIUM, "wire_aluminum")
            .aot(Mats.MAT_LEAD, "wire_lead")
            .aot(Mats.MAT_STEEL, "wire_steel")
...
public static void registerItems() {
        ...
        for (Item item : ALL_ITEMS) {
            if (item.getRegistryName() != null) {
                ...
                if (path.startsWith("spill") || path.startsWith("smoke") || path.startsWith("d_smoke") || path.startsWith("b_smoke")) {
