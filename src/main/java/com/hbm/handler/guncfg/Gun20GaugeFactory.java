...
public class Gun20GaugeFactory {
	...
	public static GunConfiguration getShotgunConfig() {
		...
		config.animations.put(HbmAnimations.AnimType.CYCLE, new BusAnimation()
				.addBus("LEVER_ROTATE", new BusAnimationSequence()
						.addKeyframe(new BusAnimationKeyframe(0.0D, 0.0D, 0.0D, 250))
						.addKeyframe(new BusAnimationKeyframe(0.0D, 0.0D, 45.0D, 500))
						.addKeyframe(new BusAnimationKeyframe(0.0D, 0.0D, 0.0D, 500)))
				.addBus("LEVER_RECOIL", new BusAnimationSequence()
						.addKeyframe(new BusAnimationKeyframe(0.5D, 0.0D, 0.0D, 50))
						.addKeyframe(new BusAnimationKeyframe(0.0D, 0.0D, 0.0D, 50))
						.addKeyframe(new BusAnimationKeyframe(0.0D, 0.0D, 0.0D, 150))
						.addKeyframe(new BusAnimationKeyframe(0.0D, -0.5D, 0.0D, 500))
						.addKeyframe(new BusAnimationKeyframe(0.0D, 0.0D, 0.0D, 500))));
	...
	public static BulletConfiguration get20GaugeConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge);
		bullet.dmgMin = 1.0F;
		bullet.dmgMax = 3.0F;
		return bullet;
	}
	...
	public static BulletConfiguration get20GaugeSlugConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_slug);
		bullet.dmgMin = 10.0F;
		bullet.dmgMax = 15.0F;
		bullet.wear = 7;
	...
	public static BulletConfiguration get20GaugeFlechetteConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_flechette);
		bullet.dmgMin = 3.0F;
		bullet.dmgMax = 6.0F;
		bullet.wear = 15;
	...
	public static BulletConfiguration get20GaugeFireConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_incendiary);
		bullet.dmgMin = 1.0F;
		bullet.dmgMax = 4.0F;
		bullet.wear = 15;
		bullet.incendiary = 5;
	...
	public static BulletConfiguration get20GaugeShrapnelConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_shrapnel);
		bullet.wear = 15;
		bullet.dmgMin = 2.0F;
		bullet.dmgMax = 6.0F;
		bullet.ricochetAngle = 15.0D;
		bullet.HBRC = 80;
		bullet.LBRC = 95;
		return bullet;
	}
	...
	public static BulletConfiguration get20GaugeExplosiveConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_explosive);
		bullet.dmgMin = 6.0F;
		bullet.dmgMax = 8.0F;
		bullet.wear = 25;
	...
	public static BulletConfiguration get20GaugeCausticConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_caustic);
		bullet.dmgMin = 2.0F;
		bullet.dmgMax = 6.0F;
		bullet.wear = 25;
		bullet.caustic = 5;
		...
		bullet.effects.add(new PotionEffect(MobEffects.POISON, 200, 1));
		return bullet;
	}

	public static BulletConfiguration get20GaugeShockConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_shock);
		bullet.dmgMin = 4.0F;
		bullet.dmgMax = 8.0F;
		bullet.wear = 25;
		bullet.emp = 2;
		...
		bullet.LBRC = 0;
		bullet.effects = new ArrayList<PotionEffect>();
		bullet.effects.add(new PotionEffect(MobEffects.SLOWNESS, 200, 1));
		bullet.effects.add(new PotionEffect(MobEffects.WEAKNESS, 200, 4));
		return bullet;
	}

	public static BulletConfiguration get20GaugeWitherConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_wither);
		bullet.dmgMin = 4.0F;
		bullet.dmgMax = 8.0F;
		bullet.effects = new ArrayList<PotionEffect>();
		bullet.effects.add(new PotionEffect(MobEffects.WITHER, 200, 2));
		return bullet;
	}
	...
	public static BulletConfiguration get20GaugeSleekConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_20gauge_sleek);
		return bullet;
	}
}
