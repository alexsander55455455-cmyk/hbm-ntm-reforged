...
public class Gun12GaugeFactory {
	...
	public static BulletConfiguration get12GaugeConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_12gauge);
		bullet.dmgMin = 1.0F;
		bullet.dmgMax = 4.0F;
		return bullet;
	}
	...
	public static BulletConfiguration get12GaugeFireConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_12gauge_incendiary);
		bullet.wear = 15;
		bullet.dmgMin = 1.0F;
		bullet.dmgMax = 4.0F;
		bullet.incendiary = 5;
	...
	public static BulletConfiguration get12GaugeShrapnelConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_12gauge_shrapnel);
		bullet.wear = 15;
		bullet.dmgMin = 2.0F;
		bullet.dmgMax = 6.0F;
	...
	public static BulletConfiguration get12GaugeDUConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_12gauge_du);
		bullet.wear = 20;
		bullet.dmgMin = 3.0F;
		bullet.dmgMax = 8.0F;
	...
	public static BulletConfiguration get12GaugeAMConfig() {
		BulletConfiguration bullet = BulletConfigFactory.standardBuckshotConfig();
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_12gauge_marauder);
		bullet.wear = 20;
	...
	public static BulletConfiguration get12GaugeSleekConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_12gauge_sleek);
		return bullet;
	}
}
