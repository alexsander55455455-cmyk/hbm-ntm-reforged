...
public class GunRocketFactory {
	...
	public static GunConfiguration getQuadroConfig() {
		...
		config.animations.put(AnimType.CYCLE, new BusAnimation()
				.addBus("QUADRO_RECOIL", new BusAnimationSequence()
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, -0.5D, 50))
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, 0D, 50))));

		config.animations.put(AnimType.RELOAD, new BusAnimation()
				.addBus("QUADRO_RELOAD_ROTATE", new BusAnimationSequence()
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, 60D, 750))
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, 60D, 3500))
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, 0D, 750)))
				.addBus("QUADRO_RELOAD_PUSH", new BusAnimationSequence()
						.addKeyframe(new BusAnimationKeyframe(-1D, -1D, 0D, 0))
						.addKeyframe(new BusAnimationKeyframe(-1D, -1D, 0D, 750))
						.addKeyframe(new BusAnimationKeyframe(-1D, 0D, 0D, 500))
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, 0D, 3000))
						.addKeyframe(new BusAnimationKeyframe(0D, 0D, 0D, 750))));
	...
	public static BulletConfiguration getRocketConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket);
		bullet.dmgMin = 10;
		bullet.dmgMax = 15;
		bullet.explosive = 4F;
		bullet.trail = 0;
	...
	public static BulletConfiguration getRocketHEConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_he);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.wear = 15;
	...
	public static BulletConfiguration getRocketIncendiaryConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_incendiary);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.wear = 15;
		bullet.explosive = 4F;
	...
	public static BulletConfiguration getRocketEMPConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_emp);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
	...
	public static BulletConfiguration getRocketSleekConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_sleek);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
	...
	public static BulletConfiguration getRocketShrapnelConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_shrapnel);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.explosive = 4F;
		bullet.shrapnel = 25;
	...
	public static BulletConfiguration getRocketGlareConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_glare);
		bullet.velocity = 5F;
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.wear = 20;
	...
	public static BulletConfiguration getRocketNukeConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_nuclear);
	...
	public static BulletConfiguration getRocketChlorineConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_toxic);
		bullet.velocity = 1.5F;
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.wear = 10;
	...
	public static BulletConfiguration getRocketRPCConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_rpc);
		bullet.velocity = 3F;
		bullet.dmgMin = 20F;
		bullet.dmgMax = 25F;
		bullet.wear = 15;
		...
		bullet.bRicochet = new IBulletRicochetBehavior() {
			...
			public void behaveBlockRicochet(EntityBulletBase bullet, int x, int y, int z) {
				...
				if(!world.isRemote && (material == Material.ROCK || material == Material.IRON || material == Material.ANVIL || material == Material.GLASS)) {
	...
	public static BulletConfiguration getRocketPhosphorusConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_phosphorus);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.wear = 15;
		bullet.explosive = 4F;
		bullet.incendiary = 5;
		bullet.trail = 9;
		bullet.bImpact = BulletConfigFactory.getPhosphorousEffect(10, 1200, 100, 0.5D, 1F);
	...
	public static BulletConfiguration getRocketCanisterConfig() {
		...
		bullet.ammo = new RecipesCommon.ComparableStack(ModItems.ammo_rocket_canister);
		bullet.dmgMin = 10F;
		bullet.dmgMax = 15F;
		bullet.explosive = 2F;
		bullet.trail = 0;
			...
			public void behaveUpdate(EntityBulletBase bullet) {
				if(!bullet.world.isRemote && bullet.ticksExisted > 10) {
					...
					for(int i = 0; i < 50; i++) {
						...
						bullet.world.spawnEntity((Entity) bolt);
					}
				}
			}
		};
