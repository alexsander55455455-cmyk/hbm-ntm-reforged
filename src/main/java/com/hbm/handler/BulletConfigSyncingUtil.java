...
private static HashMap<Integer, BulletConfiguration> configSet = new HashMap<Integer, BulletConfiguration>();
	...
	public static void loadConfigsForSync() {
		...
		configSet.put(SATURNITE_REVOLVER, Gun357MagnumFactory.getRevSteelConfig());
		...
		configSet.put(CHL_BMG50, Gun50BMGFactory.get50BMGConfig().setToHoming(new net.minecraft.item.ItemStack(ModItems.ammo_50bmg_chlorophyte)));
		...
		configSet.put(CHL_LR22, Gun22LRFactory.get22LRConfig().setToHoming(new net.minecraft.item.ItemStack(ModItems.ammo_22lr_chlorophyte)));
		configSet.put(CHL_LR22_FIRE, Gun22LRFactory.get22LRConfig().setToFire(3).setToHoming(new net.minecraft.item.ItemStack(ModItems.ammo_22lr_chlorophyte)));
		configSet.put(CHL_M44, Gun44MagnumFactory.getNoPipConfig().setToHoming(new net.minecraft.item.ItemStack(ModItems.ammo_44_chlorophyte)));
		configSet.put(CHL_R5, Gun5mmFactory.get5mmConfig().setToHoming(new net.minecraft.item.ItemStack(ModItems.ammo_5mm_chlorophyte)));
		configSet.put(CHL_R5_BOLT, Gun5mmFactory.get5mmConfig().setToHoming(new net.minecraft.item.ItemStack(ModItems.ammo_5mm_chlorophyte)).setToBolt(BulletConfiguration.BOLT_LACUNAE));
		configSet.put(CHL_R556, Gun556mmFactory.get556Config());
		configSet.put(CHL_R556_FLECHETTE, Gun556mmFactory.get556FlechetteConfig());
		...
		configSet.put(CHL_AE50, Gun50AEFactory.get50AEConfig());
		...
		configSet.put(CHL_P9, Gun9mmFactory.get9mmConfig());

		// 4 Gauge Configurations
