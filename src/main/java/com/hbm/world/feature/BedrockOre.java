...
public class BedrockOre extends AbstractPhasedStructure {
    ...
    public static void generateImmediate(World world, int x, int z, ItemStack stack, FluidStack acid, int color, int tier, Block depthRock) {
        BedrockOre oreTask = new BedrockOre(stack, acid, color, tier, depthRock);
        oreTask.executeOriginalLogic(world, world.rand, new BlockPos(x, 0, z));
    }
