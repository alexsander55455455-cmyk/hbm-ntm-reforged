...
//        ClientRegistry.bindTileEntitySpecialRenderer(TileEntityMachineAssembler.class, new RenderAssembler());
    ...
    public void registerMissileItems(IRegistry<ModelResourceLocation, IBakedModel> reg) {
        ...
        // EE Shields Rendering
        ModItems.alloy_shield.setTileEntityItemStackRenderer(new com.hbm.render.item.ItemRenderShield("S3", new ResourceLocation("hbm", "textures/items/alloy_shield.png"), new ResourceLocation("hbm", "textures/items/alloy_shield_blank.png")));
        ModItems.cmb_shield.setTileEntityItemStackRenderer(new com.hbm.render.item.ItemRenderShield("S8", new ResourceLocation("hbm", "textures/items/cmb_shield.png"), new ResourceLocation("hbm", "textures/items/cmb_shield_blank.png")));
        ModItems.cobalt_shield.setTileEntityItemStackRenderer(new com.hbm.render.item.ItemRenderShield("S6", new ResourceLocation("hbm", "textures/items/cobalt_shield.png"), new ResourceLocation("hbm", "textures/items/cobalt_shield_blank.png")));
        ModItems.desh_shield.setTileEntityItemStackRenderer(new com.hbm.render.item.ItemRenderShield("S5", new ResourceLocation("hbm", "textures/items/desh_shield.png"), new ResourceLocation("hbm", "textures/items/desh_shield_blank.png")));
        ModItems.elec_shield.setTileEntityItemStackRenderer(new com.hbm.render.item.ItemRenderShield("S4", new ResourceLocation("hbm", "textures/items/elec_shield.png"), new ResourceLocation("hbm", "textures/items/elec_shield_blank.png")));
        ModItems.schrabidium_shield.setTileEntityItemStackRenderer(new com.hbm.render.item.ItemRenderShield("S9", new ResourceLocation("hbm", "textures/items/schrabidium_shield.png"), new ResourceLocation("hbm", "textures/items/schrabidium_shield_blank.png")));
