...
public class SILEXRecipes {
	...
	public static void register() {
		...
		dictTranslation.put(SRN.dust(), SRN.ingot());
		...
		recipes.put(new ComparableStack(ModItems.crystal_schraranium), new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.nugget_schrabidium), 5)
				.addOut(new ItemStack(ModItems.nugget_uranium), 2)
				.addOut(new ItemStack(ModItems.nugget_neptunium), 2)
		);

		itemTranslation.put(new ComparableStack(ModItems.powder_unobtainium), new ComparableStack(ModItems.ingot_unobtainium));
		recipes.put(new ComparableStack(ModItems.ingot_unobtainium), new SILEXRecipe(800, 100, EnumWavelengths.GAMMA)
				.addOut(new ItemStack(ModItems.nugget_unobtainium_lesser), 99)
				.addOut(new ItemStack(ModItems.nugget_unobtainium_greater), 1)
		);
		recipes.put(GOLD.ingot(), new SILEXRecipe(800, 100, EnumWavelengths.GAMMA)
				.addOut(new ItemStack(Items.GOLD_NUGGET), 99)
				.addOut(new ItemStack(ModItems.nugget_au198), 1)
		);
		recipes.put(PB.ingot(), new SILEXRecipe(800, 100, EnumWavelengths.GAMMA)
				.addOut(new ItemStack(ModItems.nugget_lead), 99)
				.addOut(new ItemStack(ModItems.nugget_pb209), 1)
		);
		...
		recipes.put(new ComparableStack(ModItems.fluid_icon, 1, Fluids.DEATH.getID()), new SILEXRecipe(1000, 1000, EnumWavelengths.VISIBLE)
		...
		for(int i = 0; i < 5; i++) {
			...
			// UEU //
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_ueu, 1, i), new SILEXRecipe(600, 100, EnumWavelengths.IR) 	//NU and MEU will breed more plutonium due to their higher concentrations of U-238
			...
			// UZH //
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_uzh, 1, i), new SILEXRecipe(600, 100, EnumWavelengths.IR)
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_uzh, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.IR)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 1)
					.addOut(new ItemStack(ModItems.nugget_zirconium), 75)
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_lea, 1, i), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					.addOut(new ItemStack(ModItems.nugget_am_mix), 45 - 8 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM240.ordinal()), 10 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), 10 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 10 + i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 5 + 2 * i)
					.addOut(new ItemStack(ModItems.powder_coal_tiny), 20 + i) );
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_lea, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					.addOut(new ItemStack(ModItems.nugget_am_mix), 45 - 8 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM240.ordinal()), 10 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), 10 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 10 + i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 5 + 3 * i)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 20) );

			// MEA //
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_mea, 1, i), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					.addOut(new ItemStack(ModItems.nugget_am_mix), 72 - i * 12)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), 5 + 3 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), 5 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 5 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 3 + 4 * i)
					.addOut(new ItemStack(ModItems.powder_coal_tiny), 10 + i) );
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_mea, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					.addOut(new ItemStack(ModItems.nugget_am_mix), 72 - i * 12)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), 5 + 3 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), 5 + 2 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 5 + 3 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 3 + 4 * i)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 10) );

			// HEA241 //
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_hea241, 1, i), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					.addOut(new ItemStack(ModItems.nugget_am241), 85 - 15 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), 6 + 3 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), 4 + 1 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 2 + 4 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 1 + 5 * i)
					.addOut(new ItemStack(ModItems.powder_coal_tiny), 2 + 2 * i) );
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_hea241, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					...
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 2 + 4 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 1 + 5 * i)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 2 + 2 * i) );

			// HEA242 //
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_hea242, 1, i), new SILEXRecipe(600, 100, EnumWavelengths.UV)
					.addOut(new ItemStack(ModItems.nugget_am241), 91 - 16 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.PLUTONIUM241.ordinal()), 2 + 5 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.NEPTUNIUM.ordinal()), 2 + 3 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_long_tiny, 1, ItemWasteLong.WasteClass.NEPTUNIUM.ordinal()), 2 + 1 * i)
					.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.AMERICIUM242.ordinal()), 1 + 5 * i)
					.addOut(new ItemStack(ModItems.powder_coal_tiny), 2 + 2 * i) );
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_balefire, 1, i + 5), new SILEXRecipe(400, 100, EnumWavelengths.GAMMA)
					...
					.addOut(new ItemStack(ModItems.powder_balefire), 87 - i * 20)
					.addOut(new ItemStack(ModItems.nuclear_waste_tiny), 10 + 20 * i) );
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_balefire_gold, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.XRAY)
					.addOut(new ItemStack(ModItems.nugget_au198), 80 - 15 * i)
					.addOut(new ItemStack(ModItems.powder_balefire), 10 + 20 * i)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 10) );
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_flashlead, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.XRAY)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 1)
					.addOut(new ItemStack(ModItems.nugget_pb209), 8 - 1 * i)
					.addOut(new ItemStack(ModItems.nugget_au198), 8 - 1 * i)
					.addOut(new ItemStack(ModItems.powder_balefire), 1 + 2 * i) );
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_po210be, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.IR)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 3)
					.addOut(new ItemStack(ModItems.nugget_polonium), 43 - 10 * i)
					.addOut(new ItemStack(ModItems.nugget_beryllium), 44 - 10 * i)
					.addOut(new ItemStack(ModItems.nugget_lead), 5 + 10 * i)
					.addOut(new ItemStack(ModItems.powder_coal_tiny), 5 + 10 * i) );
			...
			recipes.put(new ComparableStack(ModItems.rbmk_pellet_ra226be, 1, i + 5), new SILEXRecipe(600, 100, EnumWavelengths.MICRO)
					.addOut(new ItemStack(ModItems.powder_xe135_tiny), 3)
					.addOut(new ItemStack(ModItems.nugget_ra226), 44 - 10 * i)
					.addOut(new ItemStack(ModItems.nugget_beryllium), 43 - 10 * i)
					.addOut(new ItemStack(ModItems.nugget_lead), 3 + 5 * i)
					.addOut(new ItemStack(ModItems.nugget_polonium), 2 + 5 * i)
					.addOut(new ItemStack(ModItems.powder_coal_tiny), 5 + 10 * i) );
		...
		recipes.put(OSMIRIDIUM.crystal(), new SILEXRecipe(1200, 100, EnumWavelengths.GAMMA)
				.addOut(new ItemStack(ModItems.nugget_osmiridium), 90)
				.addOut(new ItemStack(ModItems.nugget_schrabidium), 8)
				.addOut(new ItemStack(ModItems.nugget_bismuth), 2)
		);

		recipes.put(new ComparableStack(Blocks.SAND, 1), new SILEXRecipe(100, 400, EnumWavelengths.XRAY)
				.addOut(new ItemStack(ModItems.powder_quartz), 85)
				.addOut(new ItemStack(ModItems.niter), 10)
				.addOut(new ItemStack(ModItems.powder_lithium_tiny), 5)
		);
		recipes.put(new ComparableStack(ModItems.trinitite, 1), new SILEXRecipe(100, 640, EnumWavelengths.MICRO)
				.addOut(new ItemStack(Blocks.SAND), 81)
				.addOut(new ItemStack(Blocks.GRAVEL), 70)
				.addOut(new ItemStack(ModItems.nuclear_waste_tiny), 30)
				.addOut(new ItemStack(ModItems.fallout), 12)
		...
		recipes.put(new ComparableStack(ModBlocks.waste_earth, 1), new SILEXRecipe(100, 640, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(Blocks.DIRT), 54)
				.addOut(new ItemStack(ModItems.nuclear_waste_tiny), 30)
				.addOut(new ItemStack(ModItems.fallout), 10)
				.addOut(new ItemStack(ModItems.powder_cs137_tiny), 5)
				.addOut(new ItemStack(ModItems.powder_xe135_tiny), 1)
		);
		recipes.put(new ComparableStack(ModBlocks.waste_dirt, 1), new SILEXRecipe(100, 640, EnumWavelengths.UV)
				.addOut(new ItemStack(Blocks.DIRT), 111)
				.addOut(new ItemStack(Blocks.GRAVEL), 50)
				.addOut(new ItemStack(ModItems.nuclear_waste_tiny), 35)
				.addOut(new ItemStack(ModItems.nugget_lead), 3)
				.addOut(new ItemStack(ModItems.nugget_ra226), 1)
		);
		recipes.put(new ComparableStack(ModBlocks.waste_mycelium, 1), new SILEXRecipe(1000, 640, EnumWavelengths.XRAY)
				.addOut(new ItemStack(Blocks.DIRT), 100)
				.addOut(new ItemStack(Blocks.GRAVEL), 50)
				.addOut(new ItemStack(ModBlocks.mush), 35)
				.addOut(new ItemStack(ModItems.nuclear_waste_tiny), 15)
		);

		recipes.put(new ComparableStack(ModBlocks.mush_block, 1), new SILEXRecipe(100, 640, EnumWavelengths.DRX)
				.addOut(new ItemStack(ModItems.biomass_compressed), 110)
				.addOut(new ItemStack(ModBlocks.mush), 80)
				.addOut(new ItemStack(ModItems.powder_poison), 6)
				.addOut(new ItemStack(ModItems.powder_radspice), 3)
				.addOut(new ItemStack(ModItems.egg_balefire_shard), 1)
		);
		recipes.put(new ComparableStack(ModBlocks.ancient_scrap, 1), new SILEXRecipe(1000, 640, EnumWavelengths.DRX)
				.addOut(new ItemStack(ModBlocks.block_electrical_scrap), 720)
				.addOut(new ItemStack(ModItems.undefined), 20)
				.addOut(new ItemStack(ModItems.chlorine_pinwheel), 2)
				.addOut(new ItemStack(ModItems.ingot_electronium), 1)
		);

		recipes.put(IRON.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.RADIO)
				.addOut(new ItemStack(ModItems.powder_iron), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_titanium), 12)
		);
		recipes.put(COAL.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.RADIO)
				.addOut(new ItemStack(ModItems.powder_coal), 70)
				.addOut(new ItemStack(Blocks.GRAVEL), 20)
				.addOut(new ItemStack(ModItems.powder_lignite), 10)
		);
		recipes.put(GOLD.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.RADIO)
				.addOut(new ItemStack(ModItems.powder_gold), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.nugget_mercury), 12)
		);
		recipes.put(LAPIS.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.RADIO)
				.addOut(new ItemStack(ModItems.powder_lapis), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_cobalt_tiny), 12)
		);
		recipes.put(REDSTONE.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.RADIO)
				.addOut(new ItemStack(Items.REDSTONE), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 12)
				.addOut(new ItemStack(ModItems.bottle_mercury), 24)
		);
		recipes.put(CU.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.MICRO)
				.addOut(new ItemStack(ModItems.powder_copper), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.sulfur), 12)
		);
		recipes.put(PB.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.MICRO)
				.addOut(new ItemStack(ModItems.powder_lead), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_gold), 12)
		);
		recipes.put(TI.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.MICRO)
				.addOut(new ItemStack(ModItems.powder_titanium), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_iron), 12)
		);
		recipes.put(W.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.MICRO)
				.addOut(new ItemStack(ModItems.powder_tungsten), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_iron), 12)
		);
		recipes.put(AL.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.MICRO)
				.addOut(new ItemStack(ModItems.powder_aluminium), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_iron), 12)
		);
		recipes.put(LI.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.powder_lithium), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_quartz), 12)
		);
		recipes.put(S.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.sulfur), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.nugget_mercury), 12)
		);
		recipes.put(F.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.fluorite), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_lithium_tiny), 12)
		);
		recipes.put(KNO.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.niter), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_lithium), 12)
		);
		recipes.put(CO.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(ModItems.powder_cobalt), 75)
				.addOut(new ItemStack(Blocks.GRAVEL), 16)
				.addOut(new ItemStack(ModItems.powder_copper), 9)
		);
		recipes.put(BE.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(ModItems.powder_beryllium), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_emerald), 12)
		);
		recipes.put(P_RED.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(ModItems.powder_fire), 66)
				.addOut(new ItemStack(Blocks.GRAVEL), 27)
				.addOut(new ItemStack(ModItems.ingot_phosphorus), 7)
		);
		recipes.put(CINNABAR.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(ModItems.cinnebar), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(Items.REDSTONE), 12)
		);
		recipes.put(U.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(ModItems.powder_uranium), 65)
				.addOut(new ItemStack(Blocks.GRAVEL), 14)
				.addOut(new ItemStack(ModItems.powder_ra226), 21)
		);
		recipes.put(ASBESTOS.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.VISIBLE)
				.addOut(new ItemStack(ModItems.powder_asbestos), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_boron_tiny), 12)
		);
		recipes.put(TH232.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.UV)
				.addOut(new ItemStack(ModItems.powder_thorium), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_uranium), 12)
		);
		recipes.put(DIAMOND.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.UV)
				.addOut(new ItemStack(ModItems.powder_diamond), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_meteorite_tiny), 12)
		);
		recipes.put(PU.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.UV)
				.addOut(new ItemStack(ModItems.powder_plutonium), 67)
				.addOut(new ItemStack(Blocks.GRAVEL), 22)
				.addOut(new ItemStack(ModItems.powder_polonium), 11)
		);
		recipes.put(SA326.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.XRAY)
				.addOut(new ItemStack(ModItems.powder_schrabidium), 64)
				.addOut(new ItemStack(Blocks.GRAVEL), 24)
				.addOut(new ItemStack(ModItems.powder_plutonium), 12)
		);
		recipes.put(RAREEARTH.gem(), new SILEXRecipe(600, 100, EnumWavelengths.XRAY)
				.addOut(new ItemStack(ModItems.powder_boron_tiny), 15)
				.addOut(new ItemStack(ModItems.powder_cobalt_tiny), 15)
				.addOut(new ItemStack(ModItems.powder_neodymium_tiny), 5)
				.addOut(new ItemStack(ModItems.powder_niobium_tiny), 5)
				.addOut(new ItemStack(ModItems.powder_cerium_tiny), 4)
				.addOut(new ItemStack(ModItems.powder_lanthanium_tiny), 2)
				.addOut(new ItemStack(ModItems.powder_actinium_tiny), 2)
				.addOut(new ItemStack(ModItems.powder_lithium_tiny), 2)
		);
		recipes.put(RAREEARTH.crystal(), new SILEXRecipe(300, 100, EnumWavelengths.XRAY)
				.addOut(new ItemStack(ModItems.powder_boron), 15)
				.addOut(new ItemStack(ModItems.powder_cobalt), 15)
				.addOut(new ItemStack(ModItems.powder_neodymium), 5)
				.addOut(new ItemStack(ModItems.powder_niobium), 5)
				.addOut(new ItemStack(ModItems.powder_cerium), 4)
				.addOut(new ItemStack(ModItems.powder_lanthanium), 2)
				.addOut(new ItemStack(ModItems.powder_actinium), 2)
				.addOut(new ItemStack(ModItems.powder_lithium), 2)
		);
		recipes.put(STAR.crystal(), new SILEXRecipe(900, 100, EnumWavelengths.XRAY)
				.addOut(new ItemStack(ModItems.powder_astatine), 20)
				.addOut(new ItemStack(ModItems.powder_dura_steel), 24)
				.addOut(new ItemStack(ModItems.powder_cobalt), 12)
				.addOut(new ItemStack(Blocks.GRAVEL), 12)
				.addOut(new ItemStack(ModItems.nugget_mercury), 32)
		);

		for(BedrockOreType type : BedrockOreType.VALUES) {
			recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY_NOSULFURIC, type)), new SILEXRecipe(200, 100, EnumWavelengths.IR)
					.addOut(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY_NOSOLVENT, type), 9)
					.addOut(new ItemStack(Blocks.GRAVEL), 1));
			recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY_NOSOLVENT, type)), new SILEXRecipe(200, 100, EnumWavelengths.VISIBLE)
					.addOut(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY_NORAD, type), 90)
					.addOut(new ItemStack(Blocks.GRAVEL), 9)
					.addOut(ItemBedrockOreNew.extract(type.byproductAcid1, 1), 1));
			recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.PRIMARY_NORAD, type)), new SILEXRecipe(200, 100, EnumWavelengths.UV)
					.addOut(ItemBedrockOreNew.make(BedrockOreGrade.SULFURIC_WASHED, type), 90)
					.addOut(new ItemStack(Blocks.GRAVEL), 8)
					.addOut(ItemBedrockOreNew.extract(type.byproductAcid2, 1), 2));
			recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.SOLVENT_WASHED, type)), new SILEXRecipe(200, 100, EnumWavelengths.XRAY)
					.addOut(ItemBedrockOreNew.make(BedrockOreGrade.RAD_WASHED, type), 90)
					.addOut(new ItemStack(Blocks.GRAVEL), 6)
					.addOut(ItemBedrockOreNew.extract(type.byproductSolvent1, 1), 4));
			recipes.put(new ComparableStack(ItemBedrockOreNew.make(BedrockOreGrade.RAD_WASHED, type)), new SILEXRecipe(200, 100, EnumWavelengths.GAMMA)
					.addOut(ItemBedrockOreNew.extract(type.primary1, 1), 45)
					.addOut(ItemBedrockOreNew.extract(type.primary2, 1), 45)
					.addOut(new ItemStack(Blocks.GRAVEL), 2)
					.addOut(ItemBedrockOreNew.extract(type.byproductRad3, 1), 8));
		}
	}
