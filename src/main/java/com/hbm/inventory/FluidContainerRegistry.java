...
public class FluidContainerRegistry {
    ...
    public static void registerContainer(FluidContainer con) {
        if (con == null || !isValidContainer(con.fullContainer()) || con.type() == null || con.content() <= 0) return;
    ...
    private static boolean isValidContainer(@Nullable ItemStack stack) {
        return stack != null && !stack.isEmpty() && stack.getItem() != Items.AIR && Item.REGISTRY.getNameForObject(stack.getItem()) != null;
    }
