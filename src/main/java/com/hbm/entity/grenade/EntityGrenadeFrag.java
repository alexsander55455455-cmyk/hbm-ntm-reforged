...
@AutoRegister(name = "entity_grenade_frag", trackingRange = 250)
    ...
    public void explode() {
        ...
        if (!this.world.isRemote)
        {
        	if(this.isBurning())
        	{
                ...
                ExplosionChaos.burn(this.world, this, new BlockPos((int)this.posX, (int)this.posY, (int)this.posZ), 5);
                ExplosionChaos.flameDeath(this.world, this, new BlockPos((int)this.posX, (int)this.posY, (int)this.posZ), 15);
