...
@AutoRegister(name = "entity_grenade_if_incendiary", trackingRange = 250)
public class EntityGrenadeIFIncendiary extends EntityGrenadeBouncyBase {
    ...
    public void explode() {
        ...
        if (!this.world.isRemote)
        {
    		...
    		ExplosionLarge.jolt(world, this, posX, posY, posZ, 5, 200, 0.25);
    		ExplosionLarge.explode(world, this, posX, posY, posZ, 5, true, true, true);
    		ExplosionThermo.setEntitiesOnFire(world, (int)posX, (int)posY, (int)posZ, 8);
    		ExplosionChaos.flameDeath(world, this, new BlockPos((int)posX, (int)posY, (int)posZ), 15);
    		ExplosionChaos.burn(world, this, new BlockPos((int)posX, (int)posY, (int)posZ), 10);
        }
    }
