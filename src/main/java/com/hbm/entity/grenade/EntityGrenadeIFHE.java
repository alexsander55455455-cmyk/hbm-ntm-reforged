...
@AutoRegister(name = "entity_grenade_if_he", trackingRange = 250)
public class EntityGrenadeIFHE extends EntityGrenadeBouncyBase {
    ...
    public void explode() {
        ...
        if (!this.world.isRemote)
        {
    		...
    		ExplosionLarge.jolt(world, this, posX, posY, posZ, 7.5, 300, 0.25);
    		ExplosionLarge.explode(world, this, posX, posY, posZ, 7, true, true, true);
        }
    }
