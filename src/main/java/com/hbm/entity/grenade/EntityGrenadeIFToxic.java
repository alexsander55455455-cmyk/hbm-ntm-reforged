...
@AutoRegister(name = "entity_grenade_if_toxic", trackingRange = 250)
public class EntityGrenadeIFToxic extends EntityGrenadeBouncyBase {
    ...
    public void explode() {
        ...
        if (!this.world.isRemote)
        {
    		...
    		ExplosionLarge.jolt(world, this, posX, posY, posZ, 3, 200, 0.25);
    		ExplosionLarge.explode(world, this, posX, posY, posZ, 2, true, true, true);
