...
public class ModelT45Boots extends ModelBiped {
    ...
    public ModelT45Boots() {
        ...
        this.Shape1.addBox(0.0F, 0.0F, 0.0F, 4, 2, 6);
        this.Shape1.setRotationPoint(-2.0F, 9.5F, -4.0F);
        this.Shape1.setTextureSize(64, 32);
        this.Shape1.mirror = true;
        this.setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
        this.convertToChild(this.leftleg, this.Shape1);

        this.Shape2 = new ModelRenderer(this, 0, 8);
        this.Shape2.addBox(0.0F, 0.0F, 0.0F, 4, 2, 6);
        this.Shape2.setRotationPoint(-2.0F, 9.5F, -4.0F);
        this.Shape2.setTextureSize(64, 32);
        this.Shape2.mirror = true;
        this.setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
        this.convertToChild(this.rightleg, this.Shape2);

        this.Shape3 = new ModelRenderer(this, 0, 16);
        this.Shape3.addBox(0.0F, -1.0F, 0.0F, 4, 2, 4);
        this.Shape3.setRotationPoint(-2.0F, 9.5F, -4.0F);
        this.Shape3.setTextureSize(64, 32);
        this.Shape3.mirror = true;
        this.setRotation(this.Shape3, 0.2617994F, 0.0F, 0.0F);
        this.convertToChild(this.leftleg, this.Shape3);

        this.Shape4 = new ModelRenderer(this, 0, 22);
        this.Shape4.addBox(0.0F, -1.0F, 0.0F, 4, 2, 4);
        this.Shape4.setRotationPoint(-2.0F, 9.5F, -4.0F);
        this.Shape4.setTextureSize(64, 32);
        this.Shape4.mirror = true;
        this.setRotation(this.Shape4, 0.2617994F, 0.0F, 0.0F);
        this.convertToChild(this.rightleg, this.Shape4);
    }
