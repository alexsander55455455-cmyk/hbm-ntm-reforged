...
public class SmeltingRecipes {
    ...
    public static void AddSmeltingRec()
    {
        ...
        GameRegistry.addSmelting(OreDictManager.DictFrame.fromOne(ModBlocks.ore_meteor, EnumMeteorType.COPPER), new ItemStack(ModItems.ingot_copper, 16), 10.0F);
        ...
        GameRegistry.addSmelting(OreDictManager.DictFrame.fromOne(ModItems.arc_electrode_burnt, ItemArcElectrode.EnumElectrodeType.GRAPHITE), new ItemStack(ModItems.ingot_graphite), 3.0F);
        GameRegistry.addSmelting(OreDictManager.DictFrame.fromOne(ModItems.arc_electrode_burnt, ItemArcElectrode.EnumElectrodeType.LANTHANIUM), new ItemStack(ModItems.ingot_lanthanium), 3.0F);
        GameRegistry.addSmelting(OreDictManager.DictFrame.fromOne(ModItems.arc_electrode_burnt, ItemArcElectrode.EnumElectrodeType.DESH), new ItemStack(ModItems.ingot_desh), 3.0F);
        GameRegistry.addSmelting(OreDictManager.DictFrame.fromOne(ModItems.arc_electrode_burnt, ItemArcElectrode.EnumElectrodeType.SATURNITE), new ItemStack(ModItems.ingot_saturnite), 3.0F);
        ...
        GameRegistry.addSmelting(ModItems.crystal_cinnabar, new ItemStack(ModItems.cinnabar, 4), 2.0F);
